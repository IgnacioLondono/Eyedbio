...
import ClaimProfileCta from "@/components/landing/ClaimProfileCta";
...
import { getProfileDocumentTitle, resolveProfileDisplay } from "@/lib/profile/profile-display-config";
import { resolveProfileTabIconUrl } from "@/lib/profile/profile-tab-icon";
import { enterProfileFromGesture } from "@/lib/profile/profile-enter";
...
import { PROFILE_VIEW_ROOT_ATTR, teardownProfilePresentation } from "@/lib/profile/profile-teardown";
import { pathsMatchRoute, useBrowserPathname } from "@/hooks/use-browser-pathname";
